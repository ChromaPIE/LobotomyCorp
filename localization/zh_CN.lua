...
return {
    descriptions = {
        Other = {
            ...
            lobc_bless_order = {
                name = "祝佑次序",
                text = {
                    "{C:attention}出牌{} - {C:attention}手牌{} - {C:attention}牌组",
                    "仅{C:attention}祝佑{}其中第一张",
                    "未{C:attention}受祝{}的卡牌"
                }
            },
    ...
    misc = {
        ...
        v_text = {
            ch_c_lobc_ordeals = {"每隔{C:attention}2{}个底注必有一项考验"},
            ch_c_lobc_fast_ante_1 = {"{C:green}提升{}每个底注的得分要求涨幅"},
            ch_c_lobc_fast_ante_2 = {"{C:purple}剧烈提升{}每个底注的得分要求涨幅"},
            ch_c_lobc_end_ante = {"底注{C:attention}#1#{}后游戏结束"},
        ...
        dictionary = {
            ...
            lobc_disable_meltdown_color = "禁用某些挑战中的背景",
            ...
            -- Dawn
            k_lobc_dawn_green = "绿色的黎明",
            k_lobc_dawn_green_name = "疑问",
            k_lobc_dawn_green_start_1 = "有一天，一个问题在心头萦绕：我们从何而来？",
            k_lobc_dawn_green_start_2 = "我们被赋予了生命，却又被迫做这世间的孤魂。",
            k_lobc_dawn_green_end_1 = "生存就是一场苦痛的行军。",
            k_lobc_dawn_green_end_2 = "",

            k_lobc_dawn_amber = "琥珀色的黎明",
            k_lobc_dawn_amber_name = "完美的食物",
            k_lobc_dawn_amber_start_1 = "完美的食物，非凡的替代品",
            k_lobc_dawn_amber_start_2 = "",
            k_lobc_dawn_amber_end_1 = "为了生存，我们进食。退行，在所难免，废弃……",
            k_lobc_dawn_amber_end_2 = "",

            k_lobc_dawn_violet = "紫罗兰色的黎明",
            k_lobc_dawn_violet_name = "理解的成果",
            k_lobc_dawn_violet_start_1 = "为了理解那些费解之事，它们臆梦着，凝视着。",
            k_lobc_dawn_violet_start_2 = "",
            k_lobc_dawn_violet_end_1 = "不存在指使，亦无所遵照，它们为了理解而理解，仅此而已。",
            k_lobc_dawn_violet_end_2 = "",

            k_lobc_dawn_crimson = "血色的黎明",
            k_lobc_dawn_crimson_name = "为伊始喝彩",
            k_lobc_dawn_crimson_start_1 = "让我们在这宛如风中残烛的生命里，",
            k_lobc_dawn_crimson_start_2 = "纵情放一把更加绚烂的大火吧！",
            k_lobc_dawn_crimson_end_1 = "生存就是为欲念而战。",
            ...
            k_lobc_plague_apostle_1_2 = "建造在这磐石上；阴间的权柄不能胜过它。",
            k_lobc_plague_apostle_2_1 = "请告诉我们，什么时候有这些事？",
            k_lobc_plague_apostle_2_2 = "你降临和世界的末了有什么预兆呢？",
            k_lobc_plague_apostle_3_1 = "主啊，你要我们吩咐",
            k_lobc_plague_apostle_3_2 = "火从天上降下来烧灭他们？",
            k_lobc_plague_apostle_4_1 = "还有第三和第四个使徒；又给这两个人",
            k_lobc_plague_apostle_4_2 = "起名叫半尼其，就是雷子的意思。",
            k_lobc_plague_apostle_5_1 = "第五个使徒对祂说：「求主将父",
            k_lobc_plague_apostle_5_2 = "显给我们看，我们就知足了。」",
            k_lobc_plague_apostle_6_1 = "祂从那里往前走，看到一个人，第六个使徒，",
            k_lobc_plague_apostle_6_2 = "就对他说：「你跟从我来。」他就起来，跟从了祂。",
            k_lobc_plague_apostle_7_1 = "有一个人，是那第七个使徒，",
            k_lobc_plague_apostle_7_2 = "向来在那城里行邪术，妄自尊大。",
            k_lobc_plague_apostle_8_1 = "第八个使徒，就对那同作使徒",
            k_lobc_plague_apostle_8_2 = "的人说：「我们也去和祂同死吧。」",
            k_lobc_plague_apostle_9_1 = "第九个使徒说：「你是上帝的",
            k_lobc_plague_apostle_9_2 = "儿子；你是以色列的王。」",
            k_lobc_plague_apostle_10_1 = "第十个使徒问祂：「主啊，为什么",
            k_lobc_plague_apostle_10_2 = "要向我们显现，不向世人显现呢？」",
            k_lobc_plague_apostle_11_1 = "从今以后，人都不要搅扰我：",
            k_lobc_plague_apostle_11_2 = "因为我身上带着祂的印迹。",
            k_lobc_plague_apostle_12_1 = "我不是拣选了你们十二个使徒吗？",
            k_lobc_plague_apostle_12_2 = "但你们中间有一个是魔鬼。",

            ---- WhiteNight ----
            k_lobc_whitenight_confession = "承受苦难，仅仅只是赎罪的开始。",
            k_lobc_whitenight_disable = "不要否认我的存在，我就在你的眼前。",
